...
if (isset($_GET["aksi"])) {
    if ($_GET["aksi"] == "hapus") {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO transaksi_pelanggan(tanggal,id_pelanggan,total_barang) VALUE('" . date("Y-m-d") . "','$id_user','$total')");
        if (!$query) {
        ...
        foreach ($_SESSION["cart"] as $key => $value) {
            $id_produk = $value['id'];
            $jumlah = $value['jumlah'];
            $sql = "INSERT INTO detail_produk(id_transaksi, id_product, qty) VALUES ('$id_transaksi', '$id_produk', '$jumlah')";
    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">e</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="profile-pelanggan.php">
  ...
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
        ...
        Halaman utama
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="logout-pelanggan.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive small">
        ...
        <tr>
             <td>
                <img src="product/<?= $value["foto"] ?>" height="100px"><?= $value["nama"] ?>
             </td>
             <td><?= $value["jumlah"] ?></td>
...
$total = $total + ($value["jumlah"] * $value["harga"]);
        ...
        <tr>
          ...
          <td>
            <a href="keranjang.php?aksi=beli"><span class="btn btn-outline-light">Beli</span></a>
      </td>
      </tr>
      <?php
        }
